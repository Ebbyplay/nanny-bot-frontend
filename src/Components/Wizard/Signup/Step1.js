                ...
                <Form>
                    <Form.Group className="mb-3">
                        ...
                        <Form.Control 
                            ...
                            type="name" 
                            placeholder="Name" 
                            value={this.props.AuthStore.name} 
                            onChange={ (e) => this.props.AuthStore.setUsername(e.target.value) } 
                        />
                    </Form.Group>
                    ...
                    <Form.Group className="mb-3">
                        ...
                        <Form.Control 
                            ...
                            type="password" 
                            placeholder="Passwort" 
                            value={this.props.AuthStore.rePassword} 
                            onChange={ (e) => this.props.AuthStore.setRePassword(e.target.value) } 
                        />
                    </Form.Group>
